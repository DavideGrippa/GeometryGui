...
public class GUI extends Frame {
    ...
    private final Choice figure = new Choice();
    private final Button pulsante1 = new Button("DRAW");
    private final GestBottone s1 = new GestBottone();
    private final Label label1 = new Label("Scegli la figura da disegnare:");
    private final Label label2 = new Label("Inserisci l'altezza:");
    private final Label label3 = new Label("Inserisci la base:");
    private final Label label4 = new Label("Inserisci il raggio (solo cerchio):");
    private final TextField txt1 = new TextField("0");
    private final TextField txt2 = new TextField("0");
    private final TextField txt3 = new TextField("0");
